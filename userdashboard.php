...
<head>
    ...
    <link rel="stylesheet" href="assets/css/userdashboard.css"> <!-- Link sa iyong CSS file -->
    <style>
...
<body>
    ...
    <div class="dashboard">
        <div class="sidebar">
            <ul>
                ...
                <li><a href="logout.php" class="sidebar-link" data-target="logout">Log Out</a></li>
            </ul>
        </div>
        <div class="container">
            <main id="content">
    ...
    <script src="assets/js/usersdashboard.js"></script>
