...
<body>
   ...
   <img src="assets/images/hcclogo.jpg" alt="Holy Cross College Logo" style="width: 150px; height: 150px;">

 <!-- Updated with your logo -->
        <h2>Menu</h2>

        <!-- Replaced onclick with href for standard navigation -->
        <a class="button-card" href="usersdashboard.php">
            <i class="fas fa-tachometer-alt"></i>
            Dashboard
        </a>
        <a class="button-card" href="ereceipt.php">
            <i class="fas fa-tachometer-alt"></i>
            E-Receipt
        </a>
        <a class="button-card" href="changepass.php">
